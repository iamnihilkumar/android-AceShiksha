...
import com.example.edureach1.databinding.ActivityStudentReportBinding
...
import com.example.edureach1.viewmodels.ReportState
import com.example.edureach1.viewmodels.StudentReportViewModel
...
class StudentReportActivity : AppCompatActivity() {
    ...
    private fun bindReport(report: com.example.edureach1.models.StudentReport) {
    ...
    private fun addSubjectRow(container: LinearLayout, stat: SubjectStat) {
        ...
        val tvAccuracy = TextView(this).apply {
            ...
            setTextColor(resources.getColor(com.example.edureach1.R.color.primary, null))
        }
        ...
        val tvDetail = TextView(this).apply {
            ...
            textSize = 12f
            setTextColor(resources.getColor(com.example.edureach1.R.color.gray, null))
        }
        ...
        val divider = View(this).apply {
            ...
            setBackgroundColor(
                resources.getColor(com.example.edureach1.R.color.light_gray, null))
        }
        row.addView(header)
