...
import com.nikhil.aceshiksha.databinding.ActivityQuizBattleBinding
...
class QuizBattleActivity : AppCompatActivity() {
    ...
    private fun observeGame() {
        ...
        viewModel.answerResult.observe(this) { isCorrect ->
            ...
            if (isCorrect) {
                binding.tvBattleFeedback.text = "✅ Correct! +${com.nikhil.aceshiksha.utils.Constants.XP_GAME_CORRECT} XP"
