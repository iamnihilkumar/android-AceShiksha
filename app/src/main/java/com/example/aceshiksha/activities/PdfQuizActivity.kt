...
import com.nikhil.aceshiksha.adapters.GeneratedQuestionAdapter
import com.nikhil.aceshiksha.databinding.ActivityPdfQuizBinding
import com.nikhil.aceshiksha.models.GameQuestion
import com.nikhil.aceshiksha.network.GeminiContent
import com.nikhil.aceshiksha.network.GeminiPart
import com.nikhil.aceshiksha.network.GeminiRequest
import com.nikhil.aceshiksha.network.RetrofitInstance
...
class PdfQuizActivity : AppCompatActivity() {
    ...
    private var selectedClassLevel = "7"
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            val msg = when {
                ...
                e.message?.contains("400") == true ->
                    "Bad request. The prompt may be too long or malformed."
                e.message?.contains("503") == true ->
                    "AI service is temporarily unavailable. Please try again shortly."
                e.message?.contains("500") == true ->
                    "AI server error. Please try again in a moment."
            ...
            withContext(Dispatchers.Main) {
                ...
                Toast.makeText(this@PdfQuizActivity, msg, Toast.LENGTH_LONG).show()
            }
        }
        }
    }
